<template>
    <t-pdf-issues class="relative left-0 right-0 m-auto">
        ...
        <div class="flex flex-col">
            ...
            <exec_line_chart style="width: 1920px; height: 800px;" t-layer="line_identified_resolved" borderless />
        </div>
        <div class="page-break"></div>
        <t-grids gap-x="3" column-count="2">
            <div class="flex flex-col">
                <span class="text-base font-bold p-2.5">Exposure Window</span>
                <exec_line_chart style="width: 960px; height: 800px;" t-layer="line_exposure_window" borderless />
            </div>
            
            <div class="flex flex-col">
                <span class="text-base font-bold p-2.5">Time to Resolve by Week</span>
                <exec_line_chart style="width: 960px; height: 800px;" t-layer="line_mtr" borderless />
            </div>
        </t-grids>
        <div class="page-break"></div>
        <!-- Charts -->
        ...
        <t-table
            ...
            :can-sort="false"
            :canPageServer="true" 
            :layerColumnsToHide="['ORG_DISPLAY_NAME', 'PROJECT_ID', 'OPEN_P','NEW_P','RESOLVED_P','MTR_P','ORG_NAME']"
        ...
        <t-table
            ...
            :can-sort="false"
            :canPageServer="true"
            :layerColumnsToHide="['ORG_PUBLIC_ID', 'OPEN_P','NEW_P','RESOLVED_P','MTR_P','ORG_NAME']"
            style="color: black; padding-top: 10px"
        >
