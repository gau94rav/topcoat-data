<template>
    ...
    >
        ...
        <!-- Filters Right Start -->
        <t-container slot="filters" gap-x="2">
            <t-select t-layer="selected_org" t-key-column="KEY" t-value-column="VALUE" t-filter:dropdown="last_date">
                <calendar-blank-outline-icon slot="icon" size="18" />
            </t-select>
            <!-- Start Copy Link Button -->
            <div class="cursor-pointer border-[#C3C2CB] bg-white text-[13px] text-[#555463] flex gap-1 items-center border-1 rounded px-[8px] py-[7px] hover:border-[#727184] hover:text-[#727184]">
                <span style="color: #555463">
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.91675 4.08337H7.58341V5.25004H9.91675C10.8792 5.25004 11.6667 6.03754 11.6667 7.00004C11.6667 7.96254 10.8792 8.75004 9.91675 8.75004H7.58341V9.91671H9.91675C11.5267 9.91671 12.8334 8.61004 12.8334 7.00004C12.8334 5.39004 11.5267 4.08337 9.91675 4.08337ZM6.41675 8.75004H4.08341C3.12091 8.75004 2.33341 7.96254 2.33341 7.00004C2.33341 6.03754 3.12091 5.25004 4.08341 5.25004H6.41675V4.08337H4.08341C2.47341 4.08337 1.16675 5.39004 1.16675 7.00004C1.16675 8.61004 2.47341 9.91671 4.08341 9.91671H6.41675V8.75004ZM4.66675 6.41671H9.33341V7.58337H4.66675V6.41671Z" fill="#555463"/>
                    </svg>
                </span>
            </div>
        ...
        <t-container slot="mid" is-full-width is-justify-between class="pb-5">
            <div style="width: 100%" class="base-heading text-xl font-normal text-[#211F47] leading-6">
                ...
                <group-name
                    t-filter:param="groups"
                    t-layer="selected_group" />
            </div>
        </t-container>
        <!-- Mid Section End -->

        <!-- Start Big Numbers -->
        <t-big-number-group t-layer="issue_levels" slot="mid" />  
        <!-- End Big Numbers -->
