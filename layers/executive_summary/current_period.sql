...
with open as ( -- 
  ...
  where 1=1
  and is_currently_present = 'True' -- change to calculation between disappeared etc
  and org_public_id = '4a3d29ab-6612-481b-83f2-aea6cf421ea5'
  group by 1
order by 1 desc
),

new as ( -- what is new then resolved in filtered time period. comes back multiple times?
  SELECT
